    ...
    <section className="max-w-screen h-auto overflow-hidden">
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-center space-y-4 px-4 py-6 xl:py-8">
        ...
        <p className="font-inter text-xs font-medium text-[#093494] md:text-sm xl:text-base">
          ...
          investigation in every household.
          <br />
          <br />
          Parents may help their children develop a love of learning and
          exploration in addition to teaching useful life skills. For kids,
          simple activities like cooking, gardening, or housework provide a
          wealth of opportunities for education. For instance, youngsters can
          assist in food preparation while learning about measurements, and the
          science of cooking in the kitchen. They learn about ecosystems, plant
          life cycles, and the value of environmental preservation through
          gardening. Tasks around the house that involve sorting clothes,
          arranging bookcases, or preparing the table help to foster ideas of
          responsibilities, cooperation, and organization.
          <br />
          <br />
          ...
          <br />
          <br />
          Its main goal is to encourage students to have Technical, innovative,
          and creative mindset by creating a platform where students can explore
          their curiosity with support, guidance, mentoring, and access to
          resources and facilities. This will enable them to develop
