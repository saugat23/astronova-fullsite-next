...
const LeadersIntroduction = ({
  ...
  return (
    <>
      <div
        className={`xl:mx-auto xl:w-[80%] flex flex-col md:${
          reverse === true ? "flex-row-reverse" : "flex-row"
        } justify-between items-center space-y-4`}
      >
        <div
          className={`${
            reverse === true ? "border-r-8" : "border-l-8"
          } border-[#77AB33] md:w-1/2`}
        >
          <Image
            src={imgSrc}
            alt={name}
        ...
        <div className="flex-col justify-center items-start w-1/2 space-y-4">
          <h4 className="font-opensans tracking-tighter font-bold text-[#AE0D19] 2xl:text-6xl xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-xl">
            {name}
          </h4>
          <h4 className="font-opensans tracking-tighter font-bold text-[#77AB33] 2xl:text-3xl xl:text-2xl md:text-xl sm:text-lg text-base">
            {position}
          </h4>
          <p className="font-kumbhsans font-medium 2xl:text-3xl xl:text-2xl md:text-xl sm:text-lg text-base text-[#042038]">
            {desc}
          </p>
