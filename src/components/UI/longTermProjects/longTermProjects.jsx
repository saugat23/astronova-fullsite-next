...
import LongTermProjectBG from "../../../../public/projects/LongTermProjectBG.webp";
import LongTermProject1 from "../../../../public/projects/longtermproject1.webp";
        ...
        >
          ...
          <div className="flex w-full flex-col items-center justify-stretch space-x-0 space-y-3 md:flex-row md:items-start md:space-x-4 md:space-y-0">
            <ProjectContainer
              ...
              link="/long_term_projects/planetarium"
            />
            <ProjectContainer
              imgSrc={ShortTermProject2}
              name="Our Mission"
              desc="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam non sem nunc. Quisque a egestas ipsum. Donec pellentesque est maximus, ornare lorem... "
              link="/long_term_projects/establishing_workshop_lab"
            />
            <ProjectContainer
              imgSrc={ShortTermProject3}
              name="Get Involved"
              desc="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam non sem nunc. Quisque a egestas ipsum. Donec pellentesque est maximus, ornare lorem... "
              link="/long_term_projects/creative_cafe"
            />
          </div>
        </div>
